...
If you are a US undergrad, you can defer one semester and start in the spring to get CPT. For detailed instructions, please refer to [How to Get CPT with Spring Admission](../useful_docs/Spring%20入学如何拿CPT.md). Specific CPT approval details should be double-checked with the school.

## Admission Threshold & Data Points
Undergraduate majors are quite diverse -- students come from business, design, data, and CS backgrounds.

1. Fudan University undergrad, Physics, GPA 3.5
2. NYU undergrad, GPA 3.84, CS GPA 3.97, worked 9 months as SDE at Amazon Ireland
3. Renmin University CS undergrad, GPA 3.6, TOEFL 102, had Meituan DS intern
