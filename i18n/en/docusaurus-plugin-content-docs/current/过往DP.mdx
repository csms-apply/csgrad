...
<div style={{position: 'relative', width: '90%', margin: '0 auto'}}>
  <img src="/img/dp-cases/umich-cornell-meng-cs.png" alt="Original Chinese screenshot of a Jiao Tong–UMich joint undergraduate program student admitted to CMU and Cornell MEng CS" style={{display: 'block', width: '100%', height: 'auto'}} />
...
<div style={{position: 'relative', width: '90%', margin: '0 auto'}}>
  <img src="/img/dp-cases/joint-cmu-sesv.png" alt="Original Chinese screenshot of a joint Chinese–international undergraduate program student admitted to CMU SESV" style={{display: 'block', width: '100%', height: 'auto'}} />
