# Columbia MSCE
# Program Overview
A 1.5-year program. You can do a summer internship, but fall co-op is not supported. There is a thesis option — if you find a professor, you can extend your graduation timeline.
...
Verification: core course. Similar to discrete math, covering FSMs and logic.
Data Center Processing: core course. Group project to write a short paper.

# Admission Info & Data Points
There are about 60 students total, roughly 60% Chinese, 30% Indian. The Chinese students' backgrounds are quite diverse — mainland Chinese undergrads range from second-tier universities to Peking University, and US undergrads come from various schools.

1. Bard College at Simon's Rock, Physics undergrad, GPA 4.0
2. Purdue University CS undergrad, 5 years full-time at Microsoft
3. University of Nottingham Ningbo China, CS undergrad, two-month small-company internship
4. Union College CE undergrad
5. NYU CE undergrad
6. OSU CE undergrad
