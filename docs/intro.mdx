...
<section className="livestreamBanner" aria-labelledby="livestream-title">
  <div className="livestreamBanner__copy">
    <span className="livestreamBanner__eyebrow">LIVE · 两周内开播</span>
    <h2 id="livestream-title">27 Fall 申请变化与 CPT 政策影响</h2>
    <p>聊聊 27 Fall 申请季可能出现的新变化，以及“CPT 被取消”的传闻到底会不会影响留学申请、实习与求职规划。填写报名表，直播时间与参与方式确定后会第一时间通知你。</p>
  </div>
  <a
    className="livestreamBanner__button"
    href="https://forms.gle/tRbzzayD8xEmSCsf6"
    target="_blank"
    rel="noopener noreferrer"
  >
    填写表单，预约直播 <span aria-hidden="true">→</span>
  </a>
</section>

:::tip 📢 站内功能更新（2026-05-19）
