...
**DataPoints 上线**：[/datapoints](/datapoints) 收录历史 **1908 条** MSCS 申请录取数据，支持按学校 / Tier / 年份 / 结果 / 本科背景多维筛选；点击任意行可查看该申请者的全部 DP。

**提交你自己的 DP**：Google / GitHub 登录后，[/submit-dp](/submit-dp) 填写背景档案即可提交录取数据，加入历史数据库供未来申请者参考。

**选校定位 v3**：[/school-positioning](/school-positioning) 模型重构 — 支持双 GPA（陆本 + 海外/联合 GPA）、GRE 必填校验、国内外科研实习分别评估；付费 $29.99 解锁 reach / match / safety 三栏完整选校方案。
