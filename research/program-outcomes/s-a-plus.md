...
核验日期：2026-09-05。范围为 `docs/S` 11 个项目和 `docs/A+` 10 个项目及其英文对应页。使用用户 Chrome 的单个标签页，从 Google 结果打开 LinkedIn；只将 LinkedIn 教育及工作条目直接可见的信息写入正文，不以搜索摘要代替核验，不把新的实名公开履历与原有匿名案例合并。

## 已直接核验并写入正文

### CMU MSR

- 文件：`docs/S/CMU MSR.md`。
- Google 查询：`Carnegie Mellon Master of Science Robotics student alumni site:linkedin.com/in`。
- 候选及核验来源：[Yifei Liu](https://www.linkedin.com/in/yifei-migo-liu/)。
- 教育栏：UC Irvine，BS Computer Science，2019–2023；Carnegie Mellon University，MS Robotics，2023-08–2025-08。
- 工作栏：NASA Jet Propulsion Laboratory，Robotics Perception Engineer，Internship，2024-05–2024-08、2025-05–2025-08。
- 结果：项目身份、教育日期及两段实习直接可见；没有推断申请时背景或实习转正。

### CMU MSML

- 文件：`docs/S/CMU MSML.md`。
- Google 查询：`Carnegie Mellon Master Machine Learning student alumni site:linkedin.com/in`。
- 候选及核验来源：[Mihika Bairathi](https://www.linkedin.com/in/mihikabairathi/)。
- 教育栏：Carnegie Mellon University，BS Computer Science，2018-08–2022-05；同校 MS Machine Learning，2025-08–2026-12。
- 工作栏：Stripe，Software Engineer，Full-time，2022-08–2025-01；TikTok，Machine Learning Engineer Intern，Internship，2026-05–2026-08。
- 结果：直接核验。硕士栏列出的 2026-12 晚于本次核验日期，正文明确说明，不把该日期写成已经毕业。未采录 GPA 等不必要字段。

### CMU MIIS

- 文件：`docs/S/CMU MIIS.md`。
- Google 查询：`Carnegie Mellon MIIS student alumni site:linkedin.com/in`；初次结果混入 MIIPS，改用项目全称 `Carnegie Mellon "Intelligent Information Systems" alumni site:linkedin.com/in`。
- 候选及核验来源：[Alice Zheng](https://www.linkedin.com/in/jiahuialicezheng/)。
- 教育栏：Peking University，BS Computer Science，2014–2018；Carnegie Mellon University，MS Intelligent Information Systems，2018–2019。
